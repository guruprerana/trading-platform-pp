...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.7.3"
  WORKING_DIRECTORY "/Users/rayenayari/Desktop/BACHELOR/CSE201/trading-platform-pp/build/_deps/json-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v3.7.3")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v3.7.3")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/rayenayari/Desktop/BACHELOR/CSE201/trading-platform-pp/build/_deps/json-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/rayenayari/Desktop/BACHELOR/CSE201/trading-platform-pp/build/_deps/json-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
